...
const Hero = () => {
  return (
    <div className=" relative mx-auto h-[502px] md:h-[584px] justify-center items-center md:my-[3rem] flex flex-col md:flex-row lg:gap-0 md:gap-0 gap-[2rem] md:mx-[2rem] lg:mx-[4rem] xl:mx-[6.5rem]">
      <div className="bg-[#2A254B]  h-[584px]">
        <div className="relative px-10 md:px-6 lg:px-[3.5rem]">
          <h2 className={`${font.className} font-normal  leading-[44.8px] text-white text-3xl lg:text-4xl md:pt-[4rem]`}>
            The furniture brand for the future, with timeless designs
          </h2>
        </div>
        <div className="px-[3.2rem] font-satoshi font-normal flex flex-col gap-10">
          <p className={`${font.className} leading-[30px] md:relative lg:w-[602px] md:w-full text-white text-lg md:pt-[20rem]`}>
